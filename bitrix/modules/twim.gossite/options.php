    ...
    <tr>
        ...
        <td width="60%">
           ...
           <?if(!empty($arTab["PARAMETRS"]["img_boss"])):?>
                <img src="<?=$arTab["PARAMETRS"]["img_boss"]?>?v=<?=time()?>" style="display:block; max-width:200px; margin: 20px 0" alt="">
                <label>
    ...
    <tr>
        ...
        <td width="60%">
            ...
            <?if(!empty($arTab["PARAMETRS"]["img_gerb"])):?>
                <img src="<?=$arTab["PARAMETRS"]["img_gerb"]?>?v=<?=time()?>" style="display:block; max-width:200px; margin: 20px 0" alt="">
                <label>
