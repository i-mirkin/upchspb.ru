...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/town_building_docs.xml"; 
$iblockCode = "town_building_docs_".WIZARD_SITE_ID; 
...
if($iblockID == false)
{
	...
	$arFields = Array(
      ...
      array (
        ...
        'IS_REQUIRED' => 'N',
        'DEFAULT_VALUE' => '2019-01-14 14:13:05',
        'VISIBLE' => 'N',
      ),
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/town-building/docs/index.php", array("TOWN_BUILDING_DOCS" => $iblockID));
?>
