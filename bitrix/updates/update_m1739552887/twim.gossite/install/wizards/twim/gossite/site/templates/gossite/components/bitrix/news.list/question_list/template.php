        ...
        <div class="question-item" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
            ...
            <div class="wrap-question">
                <?if($arParams["DISPLAY_NAME"]!="N" && $arItem["NAME"]):?>
                        <b><?echo $arItem["NAME"]?></b> <a class="link-question-detail" href="<?=$arItem['DETAIL_PAGE_URL']?>" title="<?=getMessage("QU_DETAIL_LINK")?>"><i class="ion ion-link" aria-hidden="true"></i></a><br />
                <?endif;?>
                <div class="auhtor">
                ...
                <div id="answer_q_<?=$arItem['ID']?>" style="display:none;">
