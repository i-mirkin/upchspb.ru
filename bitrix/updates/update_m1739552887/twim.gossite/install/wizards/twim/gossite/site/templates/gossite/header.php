...
$Asset->addCss(SITE_TEMPLATE_PATH . "/css/update.css");
        ...
        <div class="wrap-form">
            ...
            <?$APPLICATION->IncludeComponent(
                ...
                array(
                    ...
                    "CATEGORY_0_TITLE" => getMessage("HEADER_PAGES_DESC"),
                    "CHECK_DATES" => "N",
                    ...
                    "CATEGORY_0_main" => "",
                    "CATEGORY_1_TITLE" => getMessage("HEADER_NEWS_DESC"),
                    "CATEGORY_1" => array(
                        0 => "iblock_documents",
                        1 => "iblock_town_building",
                        2 => "iblock_news",
                    ),
                    "CATEGORY_1_iblock_news" => array(
                        0 => "all",
                    ),
                    "CATEGORY_1_iblock_documents" => array(
                        0 => "all",
                    ),
                    "CATEGORY_1_iblock_town_building" => array(
                        0 => "all",
                    )
                ),
                false
                    ...
                    <div class="wrap-header-content">
                        <div class="b-container">
                            <div class="navbar-header">
                                ...
                                $gerbSizeClass = " gerb_size";
                                if(isset($themeConfig['gerb_size'])){
                                    $gerbSizeClass = " " . $themeConfig['gerb_size'];
                                }
                                if($themeConfig['hide_gerb'] === 'N' && $arOptionGosSite["img_gerb"]):?>
                                <div class="wrap-gerb<?=$gerbSizeClass?>"><?
                                    if($IS_MAIN != 'Y'):?>
