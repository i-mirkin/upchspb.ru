...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/coauthors.xml"; 
$iblockCode = "coauthors_".WIZARD_SITE_ID; 
	...
	$arFields = Array(
		...
		"FIELDS" => array (
			...
			array (
				...
				'IS_REQUIRED' => 'N',
				'DEFAULT_VALUE' => '2019-01-14 14:21:50',
				'VISIBLE' => 'N',
			),
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/appeals/internet-reception/new/index.php", array("COAUTHORS_IBLOCK_ID" => $iblockID));
?>