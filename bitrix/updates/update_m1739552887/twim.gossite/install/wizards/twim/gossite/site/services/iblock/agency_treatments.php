...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/agency_treatments.xml"; 
$iblockCode = "agency_treatments_".WIZARD_SITE_ID; 
	...
	$arFields = Array(
		...
		"FIELDS" => array (
			...
			array (
			  ...
			  'IS_REQUIRED' => 'N',
			  'DEFAULT_VALUE' => '2019-01-14 14:21:43',
			  'VISIBLE' => 'N',
			),
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/appeals/internet-reception/new/index.php", array("AGENCY_TREATMENTS_IBLOCK_ID" => $iblockID));
?>