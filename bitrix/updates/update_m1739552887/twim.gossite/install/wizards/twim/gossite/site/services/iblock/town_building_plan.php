...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH."/xml/".LANGUAGE_ID."/town_building_plan.xml"; 
$iblockCode = "town_building_plan_".WIZARD_SITE_ID; 
$iblockType = "town_building"; 
...
if($iblockID == false)
{
	...
	$arFields = Array(
      ...
      array (
        ...
        'IS_REQUIRED' => 'N',
        'DEFAULT_VALUE' => '2019-01-14 14:13:15',
        'VISIBLE' => 'N',
      ),
...
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/town-building/dokumentatsiya-po-planirovke-territorii/index.php", array("TOWN_BUILDING_PLAN" => $iblockID));
?>
