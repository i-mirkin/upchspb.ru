...
$date = htmlspecialchars($request->get('kdate')) ?: '';

if($date) {
	global $arCalendar;
	$arCalendar = array(						
		">=DATE_ACTIVE_FROM"=> $date . ' 00:00:00',
		"<=DATE_ACTIVE_FROM"=> $date . ' 23:59:59',
		"PROPERTY_CALENDAR_VALUE" => "Y"
	);	
	$APPLICATION->IncludeComponent("bquadro:news.list.select", "kalendar", Array(
