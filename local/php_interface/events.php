...
AddEventHandler('main', 'OnBeforeEventSend', 'setRecipientSeo');
function setRecipientSeo(&$arFields, &$arTemplate) {
    global $USER;
    if(null != $USER && $USER->GetLogin() == 'seotest') {
        $arTemplate['EMAIL_TO'] = 'client.form@bquadro.ru';
        $arTemplate['BCC'] = 'client.form@bquadro.ru';
    }
}
