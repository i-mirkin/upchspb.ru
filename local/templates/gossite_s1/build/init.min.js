App = function() {
 function u() {
  $("input, textarea").each(function() {
   0 < $(this).val().length ? $(this).addClass("valid") : $(this).removeClass("valid")
 ...
 function l(e) {
  var a = o(e),
   t = "";
  return 0 < a.h && (t = ("00" + a.h).slice(-2) + ":"), t += ("00" + a.m).slice(-2) + ":" + ("00" + a.s).slice(-2)
 }
 ...
 function d() {
  ...
  if (window.getSelection)
   if (!document.activeElement || "textarea" !== document.activeElement.tagName.toLowerCase() && "input" !== document.activeElement.tagName.toLowerCase()) {
    try {
     if (window.getSelection) var a = window.getSelection().toString();
     else a = document.getSelection()
    } catch (e) {
     console.log(e)
    }
    e = a
 ...
 return {
  init: function() {
   var e, a;
   u(), e = 0, $(window).on("resize", function() {
    ...
    function() {
     var e = 4 < $(".owl-banners-main").data("items");
    ...
    function() {
     var i = document.querySelector("#ya-map-main");
     if (i) {
      if (void 0 === jsOption.api_map_key_ya) return console.warn("twim.gossite: not key api map yandex;");
      void 0 !== window.ymaps ? e() : s("https://api-maps.yandex.ru/2.1/?apikey=" + jsOption.api_map_key_ya + "&lang=ru_RU", e)
     }

     function e() {
      ymaps.ready(function() {
       var e, a, t, o, n = "#0e4779";
       return void 0 === jsOption.coord_ya ? (console.warn("twim.gossite: not set coord map yandex;"), !1) : (void 0 !== jsOption.ya_map_iconColor && (n = jsOption.ya_map_iconColor), a = i.getAttribute("data-title"), (e = function(e) {
        for (var a = e.split(","), t = 0; t < a.length; t++) a[t] = a[t].trim();
        return !!(Array.isArray(a) && 2 <= a.length) && a
       }(jsOption.coord_ya)) ? ((t = new ymaps.Map("ya-map-main", {
        center: e,
        zoom: 10,
        controls: ["zoomControl", "fullscreenControl", "trafficControl", "typeSelector", "geolocationControl"]
       })).behaviors.disable(["scrollZoom"]), t.container.fitToViewport(), o = new ymaps.Placemark(t.getCenter(), {
        iconCaption: a
       }, {
        preset: "islands#icon",
        iconColor: n
       }), void t.geoObjects.add(o)) : (console.warn("twim.gossite: not valid coord map yandex;"), !1))
      })
     }
    ...
    }), t = [], o = [], n = new Date, $(".list-events-main .item").each(function() {
     var e = $(this).data("date"),
      a = moment(e, "DD.MM.YYYY");
     moment().isBefore(a) && o.push(e), t.push(e)
    }), 0 < o.length && (n = moment(o[0], "DD.MM.YYYY").format("MM/DD/YYYY")), $("#datetimepicker-events").datetimepicker({
     inline: !0,
     sideBySide: !1,
     useCurrent: !1,
     defaultDate: n,
    ...
    var detailRedirect = '//' + currentHost + '/kalendar/?' + dateQueryString;
    
		//window.location.replace(detailRedirect);
		window.open(detailRedirect, '_blank'); 
		
		
		
		
     //$(this).data("DateTimePicker").enabledDates(t); 
	 
	 
	 //, $(".list-events-main .item").hide(), $('.list-events-main .item[data-date="' + e.date.format("DD.MM.YYYY") + '"]').fadeIn("slow")
    }).on("dp.update", function(e) {
		$(this).data("DateTimePicker").enabledDates(t)
    }).on("dp.load", function() {
     //, $('.list-events-main .item[data-date="' + o[0] + '"]').fadeIn("slow")
    }).trigger("dp.load").trigger("dp.update"),
    function() {
    ...
    }(), a = 0, $("#search-panel").on("hidden.bs.collapse", function() {
     $("body").removeClass("no-scroll").css({
      "padding-right": ""
     }), $(".bt-overlay").remove(), $('input[type="text"]').blur()
    }), $("#search-panel").on("show.bs.collapse", function() {
     a = window.innerWidth - document.documentElement.clientWidth, $("body").addClass("no-scroll").append('<div class="bt-overlay"></div>'), $("body").css({
      "padding-right": a
    ...
    function() {
     var e = $('input[data-input="daterange"]'),
      a = e.val();
    ...
    }), $(".chocolat-gallery").slickLightbox(
    {
		 caption: function(element, info) { return $(element).find('.chocolat-image-preview').text();},
	}), $("a.view_popup_doc").on("click", function() {
     var e = $(this).attr("href"),
      a = $(this).attr("title");
     return e.split(".").pop(), $.ajax({
      url: e,
      dataType: "html",
      method: "GET",
      cache: !1
    ...
    function() {
     ...
     $(".link-open-question").click(function() {
     ...
     }), $('*[data-toggle="modal_classic"]').on("click", function(e) {
      var a = $(this),
       t = a.data("target");
      if ($(t).length < 1) {
       $("#modal_classic").clone().attr("id", t.substring(1)).appendTo("body");
       var o = a.data("load-page"),
        n = a.data("title"),
        i = $(t);
       i.find(".modal-title").text(n), $.ajax({
        url: o,
        dataType: "html",
        method: "GET",
        cache: !1,
        ...
        var a = $(e).find(".box-body");
        i.find(".modal-body").html(a), u(), l(), i.modal("show")
       }).fail(function(data) {console.log(data)
        i.find(".modal-body").html("Ошибка запроса, повторите операцию позже или обратитесь к администратору сайта"), i.modal("show")
       }).always(function() {
      ...
      var e = $("input[name='user_name']", $(this)),
       a = $("input[name='user_email']", $(this)),
       t = $("textarea[name='MESSAGE']", $(this)),
       o = $("button[type='submit']", $(this)),
       // im
       $phone = $("input[name='user_phone']", $(this)),
       $q_categ = $("select[name='q_categ']", $(this)),
       // /im
       n = $(this),
       r = $(this).parent(".mfeedback"),
       i = "N",
       s = 0;
      return 0 === e.val().length ?
          (d(e, "Укажите, как к Вам обращаться"), i = "Y") :
          e.val().length < 3 ?
              (d(e, "Должно быть не менее 3-х символов"), i = "Y") :
              c(e), 0 === t.val().length ? (d(t, "Не заполнены обязательные поля"), i = "Y") : (t.val().length < 10 || t.val().length > 500) ? (d(t, "Должно быть не менее 10 и не более 500 символов"), i = "Y") : c(t), 0 === a.val().length ? (d(a, "Не заполнены обязательные поля"), i = "Y") : /^[a-zA-Z0-9_.+-]+@[a-z0-9-]+\.[a-z]{2,6}$/i.test(a.val()) ? c(a) : (d(a, "Ошибка! Введен некорректный адрес email"), i = "Y"), "N" === i && 1 !== s && (s = 1, o.prop("disabled", !0), $.ajax({
       type: n.attr("method"),
       url: '/vopros-otvet/question.php',  
       data: n.serialize() + "&submit=y&AJAX_PAGE=Y",
       cache: !1,
       dataType: "html"
      }).done(function(e, a, t) {
       var o = $(e).find(".mfeedback");
       r.replaceWith(o);
       var n, i, s = $(e).find(".ok-message");
       1 === s.length && ($("#modal_question").modal("hide"), n = s.html(), (i = $("#modal_success")).length < 1 && ($("#modal_classic").clone().attr("id", "modal_success").appendTo("body"), (i = $("#modal_success")).find(".modal-dialog").addClass("modal-sm")), i.find(".modal-body").html(n), setTimeout(function() {
        i.modal("show")
       }, 600)), l()
      }).fail(function(e, a, t) {
       alert(a + ": " + t);
       ...
       s = 0, o.prop("disabled", !1), void 0 !== window.Recaptchafree && Recaptchafree.reset(), u()
      })), !1
     })
    }(),
    function() {
     function e(e) {
      ...
      var a = this.$content.outerHeight() - this.$content.innerHeight(),
       t = $(window).width() < 768 ? 20 : 60,
       o = $(window).height() - (t + a),
       n = this.$element.find(".modal-header").outerHeight() || 0,
    ...
    function() {
     function e(e) {
      ...
      (a = $(this).next("ul")).css({
       left: "",
       display: "block"
      }), o = a[0].getBoundingClientRect(), n = t[0].getBoundingClientRect(), a.css({
       display: ""
      }), n.right < o.right && a.css({
       left: "-" + (o.right - n.right) + "px"
      }), "mouseenter" === e.type && ($(this).attr("aria-expanded", "true"), $(this).parent("li.dropdown").addClass("open"))
     }
  ...
  onload: function() {
   $(".scrollbar-outer, .scrollbar-theme").scrollbar({
     ignoreMobile: !1,
     ignoreOverlay: !1
    }),
    function() {
     ...
     i.volume = 1, $("body").hasClass("special") && $(".soundbar").removeClass("hide"), $("a.special").on("click", function(e) {
      $(".soundbar").removeClass("hide")
     }), $("button.normal-version").on("click", function(e) {
      $(".soundbar").addClass("hide")
     }), "ontouchstart" in document.documentElement || ($(".soundbar").removeClass("soundbar_hide"), $(".wrap-content").on("mouseup", function(e) {
      var a, t;
      s = d();
      var o = $(".soundcursor");
      ...
      e()
     }), $("body").on("click", ".soundcursor", function(e) {
      if (s)
       if (3e3 < s.length) {
        var a = $("#modal_error");
        a.length < 1 && ($("#modal_classic").clone().attr("id", "modal_error").appendTo("body"), a = $("#modal_error")), a.find(".modal-dialog").addClass("modal-sm"), a.find(".modal-title").html("Ошибка"), a.find(".modal-body").html("Выделенный текст должен иметь меньше 3000 символов, текущий размер - " + s.length + " символов"), a.modal("show")
       } else $(".soundbar_loader").removeClass("soundbar_loader_hide"), $(".soundbar__play").addClass("soundbar__play_hide"), t = s, "ya" == jsOption.type_voice ? (i.pause(), n = "play", r.speak(t, {
        dataCallback: function(e) {
         "stop" !== n && (i.src = URL.createObjectURL(e), i.play(), $(".soundbar_loader").addClass("soundbar_loader_hide"), $(".soundbar__play").addClass("soundbar__play_hide"), $(".soundbar__timers").removeClass("soundbar__timers_hide"), o = setInterval(function() {
          $(".soundbar__curretn-time").text(l(i.currentTime))
         }, 1e3))
        }
       })) : "rv" == jsOption.type_voice && responsiveVoice.voiceSupport() && responsiveVoice.speak(t, "Russian Female", {
        onstart: function() {
      ...
      clearInterval(o), $(".soundbar__play").removeClass("soundbar__play_hide"), $(".soundbar__timers").addClass("soundbar__timers_hide")
     }).on("loadedmetadata", function() {
      $(".soundbar__duration-time").text(l(i.duration))
     }), $(".soundbar").on("click", function() {
      i.pause(), n = "stop", $(".soundbar__play").removeClass("soundbar__play_hide"), $(".soundbar__timers").addClass("soundbar__timers_hide"), $(".soundbar_loader").addClass("soundbar_loader_hide"), "rv" == jsOption.type_voice && responsiveVoice.cancel()
     }))
    }()
  },
  getSelectedText: d,
  removeSelectedText: e,
  secondsToTime: o,
  formatTime: l,
  loadScript: s,
