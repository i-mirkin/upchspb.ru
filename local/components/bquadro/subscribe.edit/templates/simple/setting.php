...
<form action="<?=$arResult["FORM_ACTION"]?>" method="post" class="subscription-form subscribe-left">
	...
	<button type="button" class="subscription-form__btn btn" name="Save"><?echo GetMessage("ADD_USER");?></button>
</form>
</div>
