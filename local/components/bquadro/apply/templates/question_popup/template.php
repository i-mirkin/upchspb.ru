 ...
 */
?>
<div class="mfeedback" data-f="local\components\bquadro\apply\templates\question_popup">
<?
...
<form name="apply_form" action="<?=POST_FORM_ACTION_URI?>" method="POST" class="question_form"  accept-charset="windows-1251" enctype="multipart/form-data">
	...
	<div class="file-load file-load-contact clearfix form-group">
		<div>
			<label class="label-file" for="inputFileContact">
                <p><span class="label-file__link"><?=GetMessage('MFT_FILE_UPLOAD')?>*</span><span class="label-file__formats" style="color: #202020;">jpg, jpeg, png, doc, docx, odt, txt, rtf, ppt, pptx, xls и pdf</span></p>
	...
	<?endif;?>
    <div class="form-group send_resp_email">          
        <label>
            <input type="checkbox" name="send_resp_email">
            <span><?=GetMessage("MFT_RESP_EMAIL")?></span>
        </label>
    </div>
