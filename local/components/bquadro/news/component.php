...
$smartBaseTag = ($arParams["SEF_URL_TEMPLATES"]["tag"]? $arParams["SEF_URL_TEMPLATES"]["tag"]: "#TAG_CODE#/");
$smartBaseSectionTag = ($arParams["SEF_URL_TEMPLATES"]["section_tag"]? $arParams["SEF_URL_TEMPLATES"]["section_tag"]: "#SECTION_CODE#/#TAG_CODE#/");
$arDefaultUrlTemplates404 = array(
	...
	"smart_filter_tag" => $smartBaseTag."filter/#SMART_FILTER_PATH#/apply/",
	"smart_filter_section_tag" => $smartBaseSectionTag."filter/#SMART_FILTER_PATH#/apply/"
);
...
if($arParams["SEF_MODE"] == "Y")
{
	...
	if (CModule::IncludeModule('iblock'))
	{
		...
		// $engine->setResolveCallback(array('projectHook','resolveComponentEngine'));
	}
	...
	// добавлено для тегов
	if ($componentPage === "smart_filter_tag")
		$componentPage = "tag";
		
	// добавлено для тегов
	if ($componentPage === "smart_filter_section_tag")
		$componentPage = "section_tag";
