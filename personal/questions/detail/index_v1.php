...
if (!empty($_REQUEST["action"])) {
    ...
    */
    ...
    if ($_POST['head_personally'] == 'y') $PROPERTY_VALUES['HEAD_PERSONALLY'] = 70; else $PROPERTY_VALUES['HEAD_PERSONALLY'] = null;
                    ...
                    <div class="col-lg-12">
                        ...
                        <table class="data-table">
                            ...
                            <tr>
                                <td>Заявитель</td>
                                <td>
                                    <?= $arItem['PROPERTY_USER_VALUE'] ?> <br><br>
                                    <?= $arItem['DATE_CREATE'] ?> <br><br>
                                    <?= $arItem['PROPERTY_EMAIL_VALUE'] ?> <br><br>
                            ...
                            <tr>
                                <td>Отвественный (как правило(!), начальник отдела)</td>
                                <td>
                                    <?
                                    $disabled = '';
                            ...
                            <tr>
                                <td>Исполнитель (как правило(!), сотрудник отдела)</td>
                                <td>
                                    <?
                                    // Исполнитель
                                    $disabled = 'disabled';
